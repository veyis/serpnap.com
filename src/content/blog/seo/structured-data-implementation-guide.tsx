...
export function Content({ className }: BlogContentProps) {
  return (
    <article className={className}>
      ...
      <CodeBlock>{`{\n  "@type": "Person",\n  "name": "SerpNap Team",\n  "url": "https://serpnap.com/author/serpnap-team",\n  "image": "https://serpnap.com/authors/serpnap-team.jpg",\n  "jobTitle": "AI Implementation Experts",\n  "sameAs": [\n    "https://serpnap.com",\n    "https://serpnap.com/blog"\n  ],\n  "worksFor": {\n    "@type": "Organization",\n    "name": "SerpNap"\n  }\n}`}</CodeBlock>
      ...
      <H3 id="implementation">Implementation</H3>
      <CodeBlock>{`{\n  "@context": "https://schema.org",\n  "@type": "BreadcrumbList",\n  "itemListElement": [\n    {\n      "@type": "ListItem",\n      "position": 1,\n      "name": "Home",\n      "item": "https://serpnap.com"\n    },\n    {\n      "@type": "ListItem",\n      "position": 2,\n      "name": "Services",\n      "item": "https://serpnap.com/services"\n    },\n    {\n      "@type": "ListItem",\n      "position": 3,\n      "name": "SEO Services",\n      "item": "https://serpnap.com/services/seo"\n    }\n  ]\n}`}</CodeBlock>
      <P><Strong>Benefits:</Strong></P>
      <UL>
      ...
      <H3 id="implementation">Implementation</H3>
      <CodeBlock>{`{\n  "@context": "https://schema.org",\n  "@type": "LocalBusiness",\n  "@id": "https://serpnap.com/#localbusiness",\n  "name": "SerpNap",\n  "image": "https://serpnap.com/logo.png",\n  "url": "https://serpnap.com",\n  "telephone": "+1-555-123-4567",\n  "priceRange": "\$\$",\n  "address": {\n    "@type": "PostalAddress",\n    "streetAddress": "123 Main St",\n    "addressLocality": "San Francisco",\n    "addressRegion": "CA",\n    "postalCode": "94102",\n    "addressCountry": "US"\n  },\n  "geo": {\n    "@type": "GeoCoordinates",\n    "latitude": 37.7749,\n    "longitude": -122.4194\n  },\n  "openingHoursSpecification": [\n    {\n      "@type": "OpeningHoursSpecification",\n      "dayOfWeek": ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"],\n      "opens": "09:00",\n      "closes": "17:00"\n    }\n  ],\n  "aggregateRating": {\n    "@type": "AggregateRating",\n    "ratingValue": "4.9",\n    "reviewCount": "127"\n  }\n}`}</CodeBlock>
      <P><Strong>Benefits:</Strong></P>
      <UL>
